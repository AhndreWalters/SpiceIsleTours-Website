...
- Tour booking system with form processing
- Interactive contact form
- Multi-page responsive layout
- Gallery and FAQ sections

## Pages
- `index.php` - Homepage
- `about.php`, `tours.php`, `island.php` - Content pages
- `booking.php`, `contact.php` - Interactive forms
- `login.php`, `register.php` - User authentication
- `gallery.php`, `faq.php` - Additional content

## Technology
- **PHP** - Server-side logic (64.9%)
- **CSS** - Styling (31.2%)
- **JavaScript** - Interactive elements (3.1%)
- **MySQL** - Database management
- **Docker** - Containerization support

## Educational Purpose
Demonstrates full-stack web development with PHP and MySQL, including:
